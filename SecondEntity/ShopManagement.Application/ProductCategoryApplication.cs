...
namespace ShopManagement.Application
{
    public class ProductCategoryApplication : IProductCategoryApplication
    {
        ...
        public ProductCategoryApplication(IProductCategoryRepository
            productCategoryRepository,IFileUploader fileUploader)
        {
        ...
        public OperationResult Create(CreateProductCategory command)
        {
            ...
            if (productCategoryRepository.Exists
        ...
        public OperationResult Edit(EditProductCategory command)
        {
            ...
            if (productCategoryRepository.Exists(x => x.Name ==
            command.Name && x.Id != command.Id))
        ...
        public List<ProductCategoryViewModel> Search
            (ArticleCategoriesSearchmodel searchModel)
        {
